...
/*   Updated: 2021/11/24 17:01:20 by mvaldeta         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void create_image(t_frame *rt, int obj, int bkg)
{
  if(bkg)
  {
    rt->bkg_img.img_ptr = mlx_new_image(rt->mlx_ptr, rt->scene->fov, rt->window_h);
  ...
  if(obj)
  {
    rt->obj_img.img_ptr = mlx_new_image(rt->mlx_ptr, rt->scene->fov, rt->window_h);
